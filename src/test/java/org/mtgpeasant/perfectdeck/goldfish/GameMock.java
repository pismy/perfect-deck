...
public class GameMock {
    public static Game mock(boolean onThePlay, Cards hand, Cards library, Cards graveyard, List<Permanent> board, List<Permanent> exile) {
        ...
        game.getBattlefield().addAll(board);
